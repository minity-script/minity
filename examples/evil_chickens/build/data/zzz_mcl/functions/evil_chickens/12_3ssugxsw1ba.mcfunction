...
execute if data storage zzz_mcl:evil_chickens stack[-1][0] run schedule function zzz_mcl:evil_chickens/10_y8v707w2sf 3s
execute unless data storage zzz_mcl:evil_chickens stack[-1][0] run function zzz_mcl:evil_chickens/11_fg6vx3usopo
