...
#       }
#     }
give @s minecraft:written_book{is_book:1b,pages:['{"text":"","extra":[[{"bold":true,"text":"","extra":["COLORED KEYS"]},"\\n\\n"],"",[{"text":"","extra":["Get Key","\\n",{"bold":true,"text":"","extra":[{"color":"dark_red","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_red_key"}}," ",{"color":"dark_aqua","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_blue_key"}}," ",{"color":"dark_green","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_green_key"}}," ",{"color":"gold","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_yellow_key"}}]},""]},"\\n\\n"],"",[{"text":"","extra":["Get Lock","\\n",{"bold":true,"text":"","extra":[{"color":"dark_red","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_red_lock"}}," ",{"color":"dark_aqua","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_blue_lock"}}," ",{"color":"dark_green","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_green_lock"}}," ",{"color":"gold","text":"█","clickEvent":{"action":"run_command","value":"/function colored_keys:give_yellow_lock"}}]},""]},"\\n\\n"],""]}'],title:"Colored Keys Handbook",author:"yockz",display:{Lore:["Commands and instructions for Colored Keys"]}}